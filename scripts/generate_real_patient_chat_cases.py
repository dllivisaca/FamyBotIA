...
CASES = [
    ...
    case("Muy buenas noches, querria saber si en esta sección se hace las pruebas de embarazo de sangre? cuanto seria el costo?", "consulta_servicios", ["consulta_servicios", "cotizar_servicio"], "listar_opciones", "cotizar_servicios"),
    case("Eco transvaginal precio?", "consulta_servicios", ["consulta_servicios", "cotizar_servicio"], "listar_opciones", "cotizar_servicios"),
    ...
    case("costo de un tratamiento de conducto", "consulta_servicios", ["consulta_servicios", "cotizar_servicio"], "listar_opciones", "cotizar_servicios"),
    ...
    case("Precio de blancamiento dental", "consulta_servicios", ["consulta_servicios", "cotizar_servicio"], "listar_opciones", "cotizar_servicios"),
    ...
    case("Donde están ubicados y cuanto vale la consulta con el gastroenterologo", "consulta_servicios", ["consulta_servicios", "consulta_especialidades", "consultar_ubicacion", "cotizar_servicio"], "respuesta_directa", "cotizar_servicios"),
    ...
    case("Información de ecografía abdominal completa", "consulta_servicios", ["consulta_servicios"], "listar_opciones", "consulta_servicios"),
    case("Buenas, tmb quitan caries?", "consulta_servicios", ["consulta_servicios"], "listar_opciones", "consulta_servicios"),
    ...
    case("Hola buenas que cuesta una prueba de embarazo", "consulta_servicios", ["consulta_servicios", "cotizar_servicio"], "listar_opciones", "consulta_servicios"),
    case("Buenas tardes que precio tiene el eco de las 20 semanas, eco morfológico", "consulta_servicios", ["consulta_servicios", "cotizar_servicio"], "listar_opciones", "consulta_servicios"),
    ...
    case("Buen día realizan exámenes en las mamas", "consulta_servicios", ["consulta_servicios"], "respuesta_directa", "consulta_servicios"),
    case("Tiene servicio para mamografía", "consulta_servicios", ["consulta_servicios"], "listar_opciones", "consulta_servicios"),
    ...
    case("Buenos días que precio tiene el eco renal", "consulta_servicios", ["consulta_servicios", "cotizar_servicio"], "listar_opciones", "consulta_servicios"),
    ...
    case("Buenos dias en su centro realizan resonancia contrastada abdominal", "consulta_servicios", ["consulta_servicios"], "listar_opciones", "consulta_servicios"),
    ...
    case("cardiología", "consulta_servicios", ["consulta_servicios", "consulta_especialidades"], "respuesta_directa", "consulta_especialidades"),
    case("tienen nutrición", "consulta_servicios", ["consulta_servicios", "consulta_especialidades"], "respuesta_directa", "consulta_especialidades"),
    case("Buen día cuenta con la especialidad de Cardiólogia?", "consulta_servicios", ["consulta_servicios", "consulta_especialidades"], "respuesta_directa", "consulta_especialidades"),
    case("Servicio de cardiología", "consulta_servicios", ["consulta_servicios", "consulta_especialidades"], "respuesta_directa", "consulta_especialidades"),
    case("Urología", "consulta_servicios", ["consulta_servicios", "consulta_especialidades"], "respuesta_directa", "consulta_especialidades"),
    case("Oftalmología", "consulta_servicios", ["consulta_servicios", "consulta_especialidades"], "respuesta_directa", "consulta_especialidades"),
    ...
    case("Me recomendaron hacerme una mamografía. puedo agendar el examen directamente? Qué horarios tienen disponibles y cuál sería el costo?", "consulta_servicios", ["consulta_servicios", "agendar_cita", "consultar_horario", "cotizar_servicio"], "listar_opciones", "multi_intencion"),
    case("quisiera información sobre las áreas de pediatría y dermatologia", "consulta_servicios", ["consulta_servicios", "consulta_especialidades"], "listar_opciones", "multi_intencion"),
